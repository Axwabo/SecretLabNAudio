...
public sealed partial class StreamBasedFFmpegProcessor
{
    ...
    public static StreamBasedFFmpegProcessor CreatePlayerCompatible(StreamResolver resolver, FFmpegArguments arguments, double capacity = 10, bool isOwned = true)
    ...
    public static StreamBasedFFmpegProcessor CreatePlayerCompatible(Task<Stream> resolver, FFmpegArguments arguments, double capacity = 10, bool isOwned = true)
    ...
    public StreamBasedFFmpegProcessor(Task<Stream> resolver, int sampleRate, int channels, double capacity = 10, bool isOwned = true)
        : this(_ => resolver, sampleRate, channels, capacity, isOwned)
    {
    }

    public StreamBasedFFmpegProcessor(StreamResolver resolver, FFmpegArguments arguments, double capacity = 10, bool isOwned = true)
        : this(resolver, isOwned, capacity, arguments.ReadFromStandardInput().ForFloatPiping())
    {
    }

    public StreamBasedFFmpegProcessor(Task<Stream> resolver, FFmpegArguments arguments, double capacity = 10, bool isOwned = true)
